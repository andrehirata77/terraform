...
variable "virtual_network_id" {
  description = "Virtual network ID to connect load balancer to vms"
}
variable "vms_ip_address" {
  description = "Ip addresses of the vms for load balance pool"
  default = "0.0.0.0"
}

variable "vms_ip_a" {
  description = "Ip addresse of the vm for load balance pool"
}
